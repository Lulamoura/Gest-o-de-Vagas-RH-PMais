routerAdd('POST', '/api/vagas/wordpress', (e) => {
  ...
  try {
    ...
    if (body.quantidade_vagas) {
      var qtd = parseInt(body.quantidade_vagas, 10)
    ...
    if (body.observacoes) newVacancy.set('observacoes_internas', body.observacoes)
    if (body.prioridade) newVacancy.set('prioridade', body.prioridade)
    if (body.data_abertura) newVacancy.set('data_abertura', body.data_abertura)
